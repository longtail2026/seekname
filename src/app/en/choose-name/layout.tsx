...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.seekname.cn/en/choose-name",
    languages: {
      "zh-CN": "https://www.seekname.cn/foreigner-name",
      "en-US": "https://www.seekname.cn/en/choose-name",
    },
  },
  openGraph: {
    ...
    url: "https://www.seekname.cn/en/choose-name",
    siteName: "SeekName",
    type: "website",
    locale: "en_US",
